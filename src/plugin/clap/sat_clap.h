#ifndef sat_clap_included
#define sat_clap_included
//----------------------------------------------------------------------
...
#define NUM_CLAP_PLUGIN_EXTENSIONS 35
...
struct SAT_ClapPluginExtensions {
  ...
  const clap_plugin_check_for_update_t*         check_for_update          = nullptr;
  ...
  const clap_plugin_cv_t*                       cv                        = nullptr;
  const clap_plugin_extensible_audio_ports_t*   extensible_audio_ports    = nullptr;
  const clap_plugin_midi_mappings_t*            midi_mappings             = nullptr;
...
struct SAT_ClapHostExtensions {
  ...
  const clap_host_check_for_update_t*         check_for_update        = nullptr;
  const clap_host_context_menu_t*             context_menu            = nullptr;
  const clap_host_cv_t*                       cv                      = nullptr;
  const clap_host_midi_mappings_t*            midi_mappings           = nullptr;
