#ifndef sat_cairo_painter_included
#define sat_cairo_painter_included
//----------------------------------------------------------------------
...
//------------------------------
  ...
  */
  ...
  SAT_CairoPainter(SAT_PainterOwner* AOwner)
