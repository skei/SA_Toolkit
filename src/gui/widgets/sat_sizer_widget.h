...
//------------------------------
  ...
  void on_widget_mouseClick(double AXpos, double AYpos, uint32_t AButton, uint32_t AState, uint32_t ATime) final {
  ...
  void on_widget_mouseRelease(double AXpos, double AYpos, uint32_t AButton, uint32_t AState, uint32_t ATime) final {
    if (AButton == SAT_BUTTON_LEFT) MIsDragging = false;
  }

  //----------

  void on_widget_mouseMove(double AXpos, double AYpos, uint32_t AState, uint32_t ATime) final {
    if (MIsDragging) {
