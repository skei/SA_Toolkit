...
//------------------------------
  ...
  */
  ...
  void on_widget_mouseClick(double AXpos, double AYpos, uint32_t AButton, uint32_t AState, uint32_t ATimeStamp=0) override {
    SAT_Rect mrect = getRect();
    float xcell = ( mrect.w / (float)MNumColumns );
    float ycell = ( mrect.h / (float)MNumRows );
  ...
  void on_widget_mouseMove(double AXpos, double AYpos, uint32_t AState, uint32_t ATimeStamp=0) override {
    SAT_Rect mrect = getRect();
    float xcell = ( mrect.w / (float)MNumColumns );
    float ycell = ( mrect.h / (float)MNumRows );
