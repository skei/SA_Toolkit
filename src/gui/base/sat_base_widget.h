...
//------------------------------
  ...
  // virtual SAT_Widget* appendChildWidget(SAT_Widget* AWidget) { return nullptr; }
  // virtual void        deleteChildWidgets() {}
  // virtual SAT_Widget* findChildWidget(uint32_t AXpos, uint32_t AYpos, bool ARecursive=true) { return nullptr; }
