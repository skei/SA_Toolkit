...
//------------------------------
  ...
  virtual const void* get_extension(const char *extension_id) { /*SAT_PRINT("extension id: %s\n",extension_id);*/ return nullptr; }
  virtual void        request_restart() { SAT_TRACE; }
  virtual void        request_process() { SAT_TRACE; }
  virtual void        request_callback() { SAT_TRACE; }
