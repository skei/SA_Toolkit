#ifndef sa_mael_gui_included
#define sa_mael_gui_included
//----------------------------------------------------------------------

// note:
// inserted directly into sa_mael.cpp
...
//------------------------------
  ...
  bool setupEditor(SAT_Editor* AEditor) final {
    ...
    if (window) {
      ...
      osc1_type_menu = new SAT_MenuWidget(SAT_Rect(0,0,110,20*sa_mael_osc_type_count+2+2));
      osc1_type_menu->Layout.innerBorder = SAT_Rect(2,2,2,2);
      for (uint32_t i=0; i<sa_mael_osc_type_count; i++) {
        osc1_type_menu->appendItem( osc_type_text[i] );
      }

      osc2_type_menu = new SAT_MenuWidget(SAT_Rect(0,0,110,20*sa_mael_osc_type_count+2+2));
      osc2_type_menu->Layout.innerBorder = SAT_Rect(2,2,2,2);
      for (uint32_t i=0; i<sa_mael_osc_type_count; i++) {
        osc2_type_menu->appendItem( osc_type_text[i] );
      }

      res1_type_menu = new SAT_MenuWidget(SAT_Rect(0,0,110,20*sa_mael_res_type_count+2+2));
      res1_type_menu->Layout.innerBorder = SAT_Rect(2,2,2,2);
      for (uint32_t i=0; i<sa_mael_res_type_count; i++) {
        res1_type_menu->appendItem( res_type_text[i] );
      }

      res2_type_menu = new SAT_MenuWidget(SAT_Rect(0,0,110,20*sa_mael_res_type_count+2+2));
      res2_type_menu->Layout.innerBorder = SAT_Rect(2,2,2,2);
      for (uint32_t i=0; i<sa_mael_res_type_count; i++) {
        res2_type_menu->appendItem( res_type_text[i] );
      }

      flt1_type_menu = new SAT_MenuWidget(SAT_Rect(0,0,110,20*sa_mael_flt_type_count+2+2));
      flt1_type_menu->Layout.innerBorder = SAT_Rect(2,2,2,2);
      for (uint32_t i=0; i<sa_mael_flt_type_count; i++) {
      ...
      osc1_panel->setBorderWidth(1);
        ...
        osc1_text->setTextOffset(SAT_Rect(5,5,0,0));
          ...
          SAT_KnobWidget* osc1_in_amt = new SAT_KnobWidget(SAT_Rect(88,3,26,26),"Amt",0.0);
          AEditor->connect(osc1_in_amt,getParameter(SA_MAEL_PARAM_OSC1_IN_AMOUNT));
          ...
          SAT_KnobWidget* osc1_in_sm = new SAT_KnobWidget(SAT_Rect(117,3,26,26),"Sm",0.0);
          AEditor->connect(osc1_in_sm,getParameter(SA_MAEL_PARAM_OSC1_IN_SMOOTH));
          osc1_text->appendChild(osc1_in_sm);
          osc1_in_sm->setKnobArcBackgroundColor(SAT_Grey);
          osc1_in_sm->setKnobArcColor(SAT_White);
          osc1_in_sm->setKnobArcThickness(4);
          osc1_in_sm->setDrawText(true);
          osc1_in_sm->setTextSize(5);
          osc1_in_sm->setTextColor(SAT_LightGrey);
          osc1_in_sm->setTextAlignment(SAT_TEXT_ALIGN_CENTER);
          osc1_in_sm->setDrawValueText(false);
          ...
          AEditor->connect(osc1_input1,getParameter(SA_MAEL_PARAM_OSC1_IN_O1));
          ...
          AEditor->connect(osc1_input2,getParameter(SA_MAEL_PARAM_OSC1_IN_O2));
          ...
          AEditor->connect(osc1_input3,getParameter(SA_MAEL_PARAM_OSC1_IN_R1));
          ...
          AEditor->connect(osc1_input4,getParameter(SA_MAEL_PARAM_OSC1_IN_R2));
          ...
          AEditor->connect(osc1_inputa,getParameter(SA_MAEL_PARAM_OSC1_IN_A));
          ...
          AEditor->connect(osc1_inputn,getParameter(SA_MAEL_PARAM_OSC1_IN_N));
      ...
      osc2_panel->setBorderWidth(1);
        ...
        osc2_text->setTextOffset(SAT_Rect(5,5,0,0));
          ...
          SAT_KnobWidget* osc2_in_amt = new SAT_KnobWidget(SAT_Rect(88,3,26,26),"Amt",0.0);
          AEditor->connect(osc2_in_amt,getParameter(SA_MAEL_PARAM_OSC2_IN_AMOUNT));
          ...
          SAT_KnobWidget* osc2_in_sm = new SAT_KnobWidget(SAT_Rect(117,3,26,26),"Sm",0.0);
          AEditor->connect(osc2_in_sm,getParameter(SA_MAEL_PARAM_OSC2_IN_SMOOTH));
          osc2_text->appendChild(osc2_in_sm);
          osc2_in_sm->setKnobArcBackgroundColor(SAT_Grey);
          osc2_in_sm->setKnobArcColor(SAT_White);
          osc2_in_sm->setKnobArcThickness(4);
          osc2_in_sm->setDrawText(true);
          osc2_in_sm->setTextSize(5);
          osc2_in_sm->setTextColor(SAT_LightGrey);
          osc2_in_sm->setTextAlignment(SAT_TEXT_ALIGN_CENTER);
          osc2_in_sm->setDrawValueText(false);

          SAT_SelectorWidget* osc2_type = new SAT_SelectorWidget(SAT_Rect(148,9,60,12),"Phase Mod",osc2_type_menu);
          AEditor->connect(osc2_type,getParameter(SA_MAEL_PARAM_OSC2_TYPE));
          ...
          AEditor->connect(osc2_input1,getParameter(SA_MAEL_PARAM_OSC2_IN_O1));
          ...
          AEditor->connect(osc2_input2,getParameter(SA_MAEL_PARAM_OSC2_IN_O2));
          ...
          AEditor->connect(osc2_input3,getParameter(SA_MAEL_PARAM_OSC2_IN_R1));
          ...
          AEditor->connect(osc2_input4,getParameter(SA_MAEL_PARAM_OSC2_IN_R2));
          ...
          AEditor->connect(osc2_inputa,getParameter(SA_MAEL_PARAM_OSC2_IN_A));
          ...
          AEditor->connect(osc2_inputn,getParameter(SA_MAEL_PARAM_OSC2_IN_N));
      ...
      res1_panel->setBorderWidth(1);
        ...
        res1_text->setTextOffset(SAT_Rect(5,5,0,0));
          ...
          SAT_KnobWidget* res1_in_sm = new SAT_KnobWidget(SAT_Rect(117,3,26,26),"Sm",0.0);
          AEditor->connect(res1_in_sm,getParameter(SA_MAEL_PARAM_RES1_IN_SMOOTH));
          res1_text->appendChild(res1_in_sm);
          res1_in_sm->setKnobArcBackgroundColor(SAT_Grey);
          res1_in_sm->setKnobArcColor(SAT_White);
          res1_in_sm->setKnobArcThickness(4);
          res1_in_sm->setDrawText(true);
          res1_in_sm->setTextSize(5);
          res1_in_sm->setTextColor(SAT_LightGrey);
          res1_in_sm->setTextAlignment(SAT_TEXT_ALIGN_CENTER);
          res1_in_sm->setDrawValueText(false);

          SAT_SelectorWidget* res1_type = new SAT_SelectorWidget(SAT_Rect(148,9,60,12),"---",res1_type_menu);
          AEditor->connect(res1_type,getParameter(SA_MAEL_PARAM_RES1_TYPE));
          ...
          AEditor->connect(res1_input1,getParameter(SA_MAEL_PARAM_RES1_IN_O1));
          ...
          AEditor->connect(res1_input2,getParameter(SA_MAEL_PARAM_RES1_IN_O2));
          ...
          AEditor->connect(res1_input3,getParameter(SA_MAEL_PARAM_RES1_IN_R1));
          ...
          AEditor->connect(res1_input4,getParameter(SA_MAEL_PARAM_RES1_IN_R2));
          ...
          AEditor->connect(res1_inputa,getParameter(SA_MAEL_PARAM_RES1_IN_A));
          ...
          AEditor->connect(res1_inputn,getParameter(SA_MAEL_PARAM_RES1_IN_N));
        ...
        AEditor->connect(res1_impulse,getParameter(SA_MAEL_PARAM_RES1_IMPULSE));
        res1_panel->appendChild(res1_impulse);
        res1_impulse->setTextSize(5);

        SAT_KnobWidget* res1_repeat = new SAT_KnobWidget(SAT_Rect(55,35,45,45),"Re",0);
        AEditor->connect(res1_repeat,getParameter(SA_MAEL_PARAM_RES1_REPEAT));
        res1_panel->appendChild(res1_repeat);
        res1_repeat->setTextSize(5);

        SAT_KnobWidget* res1_fb = new SAT_KnobWidget(SAT_Rect(115,35,45,45),"Fb",0);
        AEditor->connect(res1_fb,getParameter(SA_MAEL_PARAM_RES1_FEEDBACK));
        ...
        AEditor->connect(res1_damp,getParameter(SA_MAEL_PARAM_RES1_DAMPING));
        ...
        AEditor->connect(res1_gain,getParameter(SA_MAEL_PARAM_RES1_GAIN));
        ...
        AEditor->connect(res1_oct,getParameter(SA_MAEL_PARAM_RES1_OCT));
        ...
        AEditor->connect(res1_semi,getParameter(SA_MAEL_PARAM_RES1_SEMI));
        ...
        AEditor->connect(res1_cent,getParameter(SA_MAEL_PARAM_RES1_CENT));
      ...
      res2_panel->setBorderWidth(1);
        ...
        res2_text->setTextOffset(SAT_Rect(5,5,0,0));
          ...
          SAT_KnobWidget* res2_in_sm = new SAT_KnobWidget(SAT_Rect(117,3,26,26),"Sm",0.0);
          AEditor->connect(res2_in_sm,getParameter(SA_MAEL_PARAM_RES2_IN_SMOOTH));
          res2_text->appendChild(res2_in_sm);
          res2_in_sm->setKnobArcBackgroundColor(SAT_Grey);
          res2_in_sm->setKnobArcColor(SAT_White);
          res2_in_sm->setKnobArcThickness(4);
          res2_in_sm->setDrawText(true);
          res2_in_sm->setTextSize(5);
          res2_in_sm->setTextColor(SAT_LightGrey);
          res2_in_sm->setTextAlignment(SAT_TEXT_ALIGN_CENTER);
          res2_in_sm->setDrawValueText(false);

          SAT_SelectorWidget* res2_type = new SAT_SelectorWidget(SAT_Rect(148,9,60,12),"---",res2_type_menu);
          AEditor->connect(res2_type,getParameter(SA_MAEL_PARAM_RES2_TYPE));
          ...
          AEditor->connect(res2_input1,getParameter(SA_MAEL_PARAM_RES2_IN_O1));
          ...
          AEditor->connect(res2_input2,getParameter(SA_MAEL_PARAM_RES2_IN_O2));
          ...
          AEditor->connect(res2_input3,getParameter(SA_MAEL_PARAM_RES2_IN_R1));
          ...
          AEditor->connect(res2_input4,getParameter(SA_MAEL_PARAM_RES2_IN_R2));
          ...
          AEditor->connect(res2_inputa,getParameter(SA_MAEL_PARAM_RES2_IN_A));
          ...
          AEditor->connect(res2_inputn,getParameter(SA_MAEL_PARAM_RES2_IN_N));
        ...
        AEditor->connect(res2_impulse,getParameter(SA_MAEL_PARAM_RES2_IMPULSE));
        res2_panel->appendChild(res2_impulse);
        res2_impulse->setTextSize(5);

        SAT_KnobWidget* res2_repeat = new SAT_KnobWidget(SAT_Rect(55,35,45,45),"Re",0);
        AEditor->connect(res2_repeat,getParameter(SA_MAEL_PARAM_RES2_REPEAT));
        res2_panel->appendChild(res2_repeat);
        res2_repeat->setTextSize(5);

        SAT_KnobWidget* res2_fb = new SAT_KnobWidget(SAT_Rect(115,35,45,45),"Fb",0);
        AEditor->connect(res2_fb,getParameter(SA_MAEL_PARAM_RES2_FEEDBACK));
        ...
        AEditor->connect(res2_damp,getParameter(SA_MAEL_PARAM_RES2_DAMPING));
        ...
        AEditor->connect(res2_gain,getParameter(SA_MAEL_PARAM_RES2_GAIN));
        ...
        AEditor->connect(res2_oct,getParameter(SA_MAEL_PARAM_RES2_OCT));
        ...
        AEditor->connect(res2_semi,getParameter(SA_MAEL_PARAM_RES2_SEMI));
        ...
        AEditor->connect(res2_cent,getParameter(SA_MAEL_PARAM_RES2_CENT));
      ...
      flt1_panel->setBorderWidth(1);
        ...
        AEditor->connect(flt1_freq,getParameter(SA_MAEL_PARAM_FLT1_FREQ));
        ...
        AEditor->connect(flt1_bw,getParameter(SA_MAEL_PARAM_FLT1_Q));
        ...
        AEditor->connect(flt1_gain,getParameter(SA_MAEL_PARAM_FLT1_GAIN));
      ...
      global_panel->setBorderWidth(1);
        ...
        AEditor->connect(global_gain,getParameter(SA_MAEL_PARAM_GLOBAL_GAIN));
      ...
      MVoicesWidget = new SAT_VoicesWidget(SAT_Rect(290,285,200,20),SA_MAEL_MAX_VOICES);
