...
clap_param_info_t sa_botage_parameter_infos[SA_BOTAGE_PARAM_COUNT] = {
  ...
  { SA_BOTAGE_PARAM_PROB_RANGE_LENGTH_MIN,  A,    nullptr,  "Range Length Min", "ProbRange", -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_RANGE_LENGTH_MAX,  A,    nullptr,  "Range Length Max", "ProbRange", -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_RANGE_SPEED,       A,    nullptr,  "Range Speed",      "ProbRange",  0.0, 1.0, 0.5    },
  { SA_BOTAGE_PARAM_PROB_RANGE_SPEED_MIN,   A,    nullptr,  "Range Speed Min",  "ProbRange", -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_RANGE_SPEED_MAX,   A,    nullptr,  "Range Speed Max",  "ProbRange", -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_RANGE_OFFSET,      A,    nullptr,  "Range Offset",     "ProbRange",  0.0, 1.0, 0.5    },
  { SA_BOTAGE_PARAM_PROB_RANGE_OFFSET_MIN,  A,    nullptr,  "Range Offset Min", "ProbRange", -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_RANGE_OFFSET_MAX,  A,    nullptr,  "Range Offset Max", "ProbRange", -1.0, 1.0, 0.0    },
  ...
  { SA_BOTAGE_PARAM_PROB_RANGE_FX_MIN,      A,    nullptr,  "Range FX Min",     "ProbRange", -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_RANGE_FX_MAX,      A,    nullptr,  "Range FX Max",     "ProbRange", -1.0, 1.0, 0.0    },

  // Probabilities - Loop

  { SA_BOTAGE_PARAM_PROB_LOOP_LENGTH,       A,    nullptr,  "Loop Length",      "ProbLoop",   0.0, 1.0, 0.5    },
  { SA_BOTAGE_PARAM_PROB_LOOP_LENGTH_MIN,   A,    nullptr,  "Loop Length Min",  "ProbLoop",  -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_LOOP_LENGTH_MAX,   A,    nullptr,  "Loop Length Max",  "ProbLoop",  -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_LOOP_SPEED,        A,    nullptr,  "Loop Speed",       "ProbLoop",   0.0, 1.0, 0.5    },
  { SA_BOTAGE_PARAM_PROB_LOOP_SPEED_MIN,    A,    nullptr,  "Loop Speed Min",   "ProbLoop",  -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_LOOP_SPEED_MAX,    A,    nullptr,  "Loop Speed Max",   "ProbLoop",  -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_LOOP_OFFSET,       A,    nullptr,  "Loop Offset",      "ProbLoop",   0.0, 1.0, 0.5    },
  { SA_BOTAGE_PARAM_PROB_LOOP_OFFSET_MIN,   A,    nullptr,  "Loop Offset Min",  "ProbLoop",  -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_LOOP_OFFSET_MAX,   A,    nullptr,  "Loop Offset Max",  "ProbLoop",  -1.0, 1.0, 0.0    },
  ...
  { SA_BOTAGE_PARAM_PROB_LOOP_FX_MIN,       A,    nullptr,  "Loop FX Min",      "ProbLoop",  -1.0, 1.0, 0.0    },
  { SA_BOTAGE_PARAM_PROB_LOOP_FX_MAX,       A,    nullptr,  "Loop FX Max",      "ProbLoop",  -1.0, 1.0, 0.0    },
...
bool sa_botage_SetupParameters(SAT_Plugin* APlugin) {
  ...
  // Buffer
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_BUFFER_BEATS] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_BUFFER_SLICES] ));
  // Trigger
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_TRIGGER] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_TRIGGER_SLICES] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_TRIGGER_LOOP] ));
  // Probabilities - Range
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_LENGTH] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_LENGTH_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_LENGTH_MAX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_SPEED] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_SPEED_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_SPEED_MAX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_OFFSET] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_OFFSET_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_OFFSET_MAX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_REVERSE] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_FX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_FX_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_RANGE_FX_MAX] ));
  // Probabilities - Loop
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_LENGTH] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_LENGTH_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_LENGTH_MAX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_SPEED] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_SPEED_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_SPEED_MAX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_OFFSET] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_OFFSET_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_OFFSET_MAX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_REVERSE] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_FX] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_FX_MIN] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_LOOP_FX_MAX] ));
  // Probabilities - FX
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX1] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX1_TYPE] ));
  ...
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX2] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX2_TYPE] ));
  ...
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX3] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX3_TYPE] ));
  ...
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX4] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX4_TYPE] ));
  ...
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX5] ));
  APlugin->appendParameter( new SAT_Parameter( &sa_botage_parameter_infos[SA_BOTAGE_PARAM_PROB_FX5_TYPE] ));
