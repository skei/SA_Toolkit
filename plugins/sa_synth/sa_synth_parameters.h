...
enum sa_synth_parameter_e {
  ...
  SA_SYNTH_PARAM_RES1_IMPULSE_FREQ,
  SA_SYNTH_PARAM_RES1_FEEDBACK,
  SA_SYNTH_PARAM_RES1_DAMPING_FREQ,
  SA_SYNTH_PARAM_RES1_GAIN,
  ...
  SA_SYNTH_PARAM_RES2_IMPULSE_FREQ,
  SA_SYNTH_PARAM_RES2_FEEDBACK,
  SA_SYNTH_PARAM_RES2_DAMPING_FREQ,
  SA_SYNTH_PARAM_RES2_GAIN,
...
clap_param_info_t sa_synth_parameters[SA_SYNTH_PARAM_COUNT] = {
  ...
  { SA_SYNTH_PARAM_OSC1_TYPE,         A|SE,   nullptr,  "Type",     "Osc1",     0,   sa_synth_osc_type_count - 1, 0 },
  { SA_SYNTH_PARAM_OSC1_IN_AMOUNT,    AMN,    nullptr,  "Amt",      "Osc1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC1_IN_O1,        A,      nullptr,  "O1",       "Osc1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC1_IN_O2,        A,      nullptr,  "O2",       "Osc1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC1_IN_R1,        A,      nullptr,  "R1",       "Osc1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC1_IN_R2,        A,      nullptr,  "R2",       "Osc1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC1_IN_A,         A,      nullptr,  "A",        "Osc1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC1_IN_N,         A,      nullptr,  "N",        "Osc1",     0.0, 1.0, 0.0 },
  ...
  { SA_SYNTH_PARAM_OSC2_TYPE,         A|SE,   nullptr,  "Type",     "Osc2",     0,   sa_synth_osc_type_count - 1, 0 },
  { SA_SYNTH_PARAM_OSC2_IN_AMOUNT,    AMN,    nullptr,  "Amt",      "Osc2",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC2_IN_O1,        A,      nullptr,  "O1",       "Osc2",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC2_IN_O2,        A,      nullptr,  "O2",       "Osc2",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC2_IN_R1,        A,      nullptr,  "R1",       "Osc2",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC2_IN_R2,        A,      nullptr,  "R2",       "Osc2",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_OSC2_IN_A,         A,      nullptr,  "A",        "Osc2",     0.0, 1.0, 0.0 },
  ...
  { SA_SYNTH_PARAM_RES1_TYPE,         A|SE,   nullptr,  "Type",     "Res1",     0.0, sa_synth_res_type_count - 1, 0 },
  { SA_SYNTH_PARAM_RES1_IN_AMOUNT,    AMN,    nullptr,  "Amt",      "Res1",     0.0, 1.0, 1.0 },
  { SA_SYNTH_PARAM_RES1_IN_O1,        A,      nullptr,  "O1",       "Res1",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_RES1_IN_O2,        A,      nullptr,  "O2",       "Res1",     0.0, 1.0, 0.0 },
  ...
  { SA_SYNTH_PARAM_RES2_TYPE,         A|SE,   nullptr,  "Type",     "Res2",     0, sa_synth_res_type_count - 1, 0 },
  { SA_SYNTH_PARAM_RES2_IN_AMOUNT,    AMN,    nullptr,  "Amt",      "Res2",     0.0, 1.0, 1.0 },
  { SA_SYNTH_PARAM_RES2_IN_O1,        A,      nullptr,  "O1",       "Res2",     0.0, 1.0, 0.0 },
  { SA_SYNTH_PARAM_RES2_IN_O2,        A,      nullptr,  "O2",       "Res2",     0.0, 1.0, 0.0 },
  ...
  { SA_SYNTH_PARAM_FLT1_TYPE,         A|SE,   nullptr,  "Type",     "Flt1",     0, sa_synth_flt_type_count - 1, 1 },
...
bool sa_synth_setup_parameters(SAT_Plugin* APlugin) {
  ...
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES1_IMPULSE_FREQ] ));
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES1_FEEDBACK] ));
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES1_DAMPING_FREQ] ));
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES1_GAIN] ));
  ...
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES2_IMPULSE_FREQ] ));
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES2_FEEDBACK] ));
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES2_DAMPING_FREQ] ));
  APlugin->appendParameter( new SAT_Parameter(    &sa_synth_parameters[SA_SYNTH_PARAM_RES2_GAIN] ));
