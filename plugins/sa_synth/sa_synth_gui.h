...
//----------------------------------------------------------------------
  ...
  bool initEditorWindow(SAT_Editor* AEditor/*, SAT_Window* AWindow*/) final {
    ...
    SAT_PanelWidget* osc_section = new SAT_PanelWidget(SAT_Rect(5,20,105,105));
    root->appendChildWidget(osc_section);
    //osc_section->setAlignment(SAT_WIDGET_ALIGN_LEFT_TOP);

      // osc
      
      SAT_MenuWidget* osc_menu = new SAT_MenuWidget(SAT_Rect(75,50));
      SAT_MenuItemWidget* osc_item1 = (SAT_MenuItemWidget*)osc_menu->appendChildWidget( new SAT_MenuItemWidget(10,"morph"));
      SAT_MenuItemWidget* osc_item2 = (SAT_MenuItemWidget*)osc_menu->appendChildWidget( new SAT_MenuItemWidget(10,"dsf"));
      SAT_MenuItemWidget* osc_item3 = (SAT_MenuItemWidget*)osc_menu->appendChildWidget( new SAT_MenuItemWidget(10,"padsynth"));
      SAT_MenuItemWidget* osc_item4 = (SAT_MenuItemWidget*)osc_menu->appendChildWidget( new SAT_MenuItemWidget(10,"wavetable"));
      SAT_MenuItemWidget* osc_item5 = (SAT_MenuItemWidget*)osc_menu->appendChildWidget( new SAT_MenuItemWidget(10,"input"));
      osc_item1->setTextSize(7);
      osc_item2->setTextSize(7);
      osc_item3->setTextSize(7);
      osc_item4->setTextSize(7);
      osc_item5->setTextSize(7);
      
      SAT_SelectorWidget* osc_sel = new SAT_SelectorWidget(SAT_Rect(5,5,70/*95*/,12),"<select>",osc_menu);
      osc_section->appendChildWidget(osc_sel);
      //AEditor->connect(flt_sel,getParameter(6));
      
      SAT_ButtonWidget* osc_but = new SAT_ButtonWidget(SAT_Rect(80,5,20,12),false);
      osc_section->appendChildWidget(osc_but);
      osc_but->setTexts("","");
      
      //

      knob = new SAT_KnobWidget(SAT_Rect(5,25,50,50),"shp",0);
      ...
      knob = new SAT_KnobWidget(SAT_Rect(70,45,30,30),"tun",0);
      osc_section->appendChildWidget(knob);
      ...
      knob = new SAT_KnobWidget(SAT_Rect(5,80,20,20),"a",0);
      osc_section->appendChildWidget(knob);
      ...
      knob = new SAT_KnobWidget(SAT_Rect(30,80,20,20),"d",0);
      osc_section->appendChildWidget(knob);
      ...
      knob = new SAT_KnobWidget(SAT_Rect(55,80,20,20),"s",0);
      osc_section->appendChildWidget(knob);
      ...
      knob = new SAT_KnobWidget(SAT_Rect(80,80,20,20),"r",0);
      osc_section->appendChildWidget(knob);
    ...
    //res_section->setAlignment(SAT_WIDGET_ALIGN_LEFT_TOP);
      ...
      SAT_MenuItemWidget* flt_item1 = (SAT_MenuItemWidget*)flt_menu->appendChildWidget( new SAT_MenuItemWidget(10,"off"));
      SAT_MenuItemWidget* flt_item2 = (SAT_MenuItemWidget*)flt_menu->appendChildWidget( new SAT_MenuItemWidget(10,"lowpass"));
      SAT_MenuItemWidget* flt_item3 = (SAT_MenuItemWidget*)flt_menu->appendChildWidget( new SAT_MenuItemWidget(10,"highpass"));
      SAT_MenuItemWidget* flt_item4 = (SAT_MenuItemWidget*)flt_menu->appendChildWidget( new SAT_MenuItemWidget(10,"bandpass"));
      SAT_MenuItemWidget* flt_item5 = (SAT_MenuItemWidget*)flt_menu->appendChildWidget( new SAT_MenuItemWidget(10,"notch"));
      flt_item1->setTextSize(7);
      flt_item2->setTextSize(7);
      flt_item3->setTextSize(7);
      flt_item4->setTextSize(7);
      flt_item5->setTextSize(7);
    ...
    MVoicesWidget = new SAT_VoicesWidget(SAT_Rect(225,5,105,5), NUM_VOICES);
    root->appendChildWidget(MVoicesWidget);
    
    // gain
    
    knob = new SAT_KnobWidget(SAT_Rect(225,15,30,30),"G",1);
    ...
    root->appendChildWidget(osc_menu);
