...
public:
  virtual void on_widgetListener_update(SAT_Widget* AWidget, uint32_t AIndex, uint32_t AMode) {}
  virtual void on_widgetListener_redraw(SAT_Widget* AWidget, uint32_t AIndex, uint32_t AMode) {}
  virtual void on_widgetListener_realign(SAT_Widget* AWidget, uint32_t AMode) {}
